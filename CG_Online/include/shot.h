...
*/
//inline bool areEquals(double val1, double val2, double zeroDoubleEps = EQUAL_ZERO_TH){return (std::abs(val1 - val2)<zeroDoubleEps);}; 
inline bool areEquals(double val1, double val2, double zeroDoubleEps = EQUAL_ZERO_TH){return (fabs(val1 - val2)<zeroDoubleEps);};
